...
<script type="text/javascript">
	...
	function searchUser(){
		 $("#dg").datagrid('load',{
			"userName":$("#s_userName").val() //获取输入的用户名的值
		 });
	}
	...
	function deleteUser(){
		...
		var strIds=[]; //批量删除多个数据的到时候，会有多个用户的id组成数组
...
<body style="margin: 1px">
	...
	<div id="tb">
	 ...
	 <!--添加用户对话框dialog  -->
	 <div id="dlg" class="easyui-dialog" style="width:650px;height:250px;padding: 10px 20px"
