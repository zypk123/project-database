	...
	function modifyPassword(){
		$("#fm").form("submit",{
			...
			success:function(result){
				var result=eval('('+result+')');// 执行json字符串
				if(result.success){
...
<body class="easyui-layout"> <!--class后面加easyui-XX代表使用easyui组件  -->
	<!-- 上部 north-->
		...
		<table style="padding: 5px" width="100%">
			<tr>
				...
				<td valign="bottom" align="right" width="50%">
					<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${currentUser.userName}</font>【${currentUser.trueName }】【${currentUser.roleName }】<!-- el表达式获取后台传递来的信息 -->
				</td>
			</tr>
		</table>
	</div>
	...
	<!-- 下部south -->
	<div region="south" style="height: 27px;padding: 5px" align="center">
		承建方@<font color="blue" size="2">合肥宏晶信息科技有限公司</font> <a href="http://www.itek-training.com/" target="_blank">http://www.itek-training.com/</a>
	</div>
